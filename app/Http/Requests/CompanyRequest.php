...
class CompanyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            'name' => 'required',
            'email' => 'required|email|unique:companies|regex:/^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,6}$/ix',
            'phone' => 'required|digits:10|numeric|regex:/[0-9]{10}/|unique:companies'
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'phone.unique' => 'This phone is used',
        ];
    }
}
